-- ShelfCue Form Editor - Database Migrations (FIXED VERSION)
...
-- Step 3: Create form_views table if it doesn't exist
...
-- Step 8: Add indexes for better performance (only if they don't exist)
...
-- Done! Your database is now ready for ShelfCue
