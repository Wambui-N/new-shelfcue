...
export default function SignUpPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (needsConsent) {
        setError(
          "Please complete the signup process to grant permissions for Google Calendar and Sheets integration.",
        );
      }
    }
  }, []);
      ...
      <div className="bg-muted/30 rounded-lg p-4 space-y-3">
        ...
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            Forms sync directly to your Google Sheets
          </p>
        </div>
        <div className="flex items-start gap-2">
          <Calendar className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
          <p className="text-xs text-muted-foreground">
            Automatic meeting scheduling via Google Calendar
          </p>
        </div>
        <div className="flex items-start gap-2">
      ...
      <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
        ...
        <ul className="space-y-2 text-xs text-muted-foreground">
          <li className="flex items-start gap-2">
            ...
            <span>
              Connect your Google account (required for Sheets & Calendar)
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-primary font-bold">2.</span>
            <span>Start creating unlimited forms instantly</span>
          </li>
          <li className="flex items-start gap-2">
