    ...
    const fetchAnalytics = async () => {
      ...
      try {
        ...
        if (!submissionsError) {
          ...
          const formsThisMonth = forms?.filter(form =>
          ...
          const formAnalytics = forms?.map(form => {
            ...
            const formConversion = formViews > 0 ? Math.round((formSubmissions.length / formViews) * 100) : 0
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">Track your form performance and understand your audience</p>
      </div>
      ...
      <Card className="p-4 border-border shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            {['Last 7 days', 'Last 30 days', 'Last 3 months'].map((range, index) => (
              <Badge
                key={range}
          ...
          >
            <Card className="p-6 shadow-sm hover:shadow-lg transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 rounded-xl bg-muted flex items-center justify-center ${metric.color}`}>
                  {metric.icon}
                </div>
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h4 className="font-medium text-foreground">{form.form}</h4>
                        {form.trend === 'up' ? (
                          <ArrowUpRight className="w-4 h-4 text-green-500" />
                        ) : (
                          <ArrowDownRight className="w-4 h-4 text-red-500" />
              ...
              <>
                  ...
                  return (
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-blue-900 dark:text-blue-100">Best Performing Form</h4>
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-green-900 dark:text-green-100">Total Activity</h4>
                      <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                        You've received {analyticsData.totalSubmissions} submissions from {analyticsData.totalViews} views
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-xl border border-orange-200 dark:border-orange-800">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-orange-900 dark:text-orange-100">Optimization Tip</h4>
