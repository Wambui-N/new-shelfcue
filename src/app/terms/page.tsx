        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-foreground-muted">
              By accessing Shelfcue, you confirm you're at least 18 years old and agree to these terms. The service is operated from Kenya.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">2. Account Registration</h2>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
              <li><strong>Processor:</strong> Paystack handles all payments</li>
              <li><strong>Billing:</strong> Subscriptions auto-renew monthly/annually</li>
              <li><strong>Refunds:</strong> No refunds for partial periods</li>
              <li><strong>Price Changes:</strong> 30-day email notice for price increases</li>
              <li><strong>Trial:</strong> Service automatically converts to paid after 14 days</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">5. Acceptable Use</h2>
            ...
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
              ...
              <li>Collect sensitive information (health, financial, SSN) without proper consent</li>
              <li>Abuse or overwhelm our infrastructure</li>
              <li>Violate others' privacy rights</li>
            </ul>
            <p className="text-foreground-muted mt-4">
              We may suspend accounts for: Misuse, non-payment, or terms violations.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">6. Data & Privacy</h2>
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
              <li>You own all form data and submissions</li>
              <li>You're responsible for complying with privacy laws (CCPA, GDPR, etc.)</li>
              <li>You must obtain proper consent from people filling your forms</li>
              <li>We may remove content violating these terms</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">7. Intellectual Property</h2>
            <p className="text-foreground-muted">
              Shelfcue owns the platform and software. You own your form data and content.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">8. Service Level</h2>
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-foreground-muted mb-4">To the extent permitted by Kenyan law:</p>
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
              <li>We're not liable for business losses from service interruptions</li>
              <li>Maximum liability limited to your last 3 months of payments</li>
              <li>We're not responsible for data loss between Shelfcue and Google Sheets</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">10. Termination</h2>
            <ul className="list-disc pl-6 text-foreground-muted space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6">11. Governing Law</h2>
            <p className="text-foreground-muted">
