...
export const countries: Country[] = [
  ...
  { code: 'LY', name: 'Libyan Arab Jamahiriya', phone: '+218' },
  ...
  { code: 'AN', name: 'Netherlands Antilles', phone: '+599' },
  ...
  { code: 'PS', name: 'Palestinian Territory, Occupied', phone: '+970' },
  ...
  { code: 'VG', name: 'Virgin Islands, British', phone: '+1-284' },
  { code: 'VI', name: 'Virgin Islands, U.s.', phone: '+1-340' },
