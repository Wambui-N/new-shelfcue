  ...
  if (submitStatus === 'success') {
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">{formData.settings.successMessage}</p>
      </motion.div>
    )
  }
    ...
    >
      ...
      >
        {formData.settings.showTitle && (
          <h1 className="text-2xl font-bold mb-2" style={{ color: formData.theme.textColor }}>
            {formData.title}
          </h1>
        )}
        
        {formData.settings.showDescription && formData.description && (
          <p className="mb-6 opacity-75" style={{ color: formData.theme.textColor }}>
