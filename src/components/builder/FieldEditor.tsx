...
export function FieldEditor() {
  const { formData, addField, updateField, removeField, reorderFields } = useFormStore()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-medium text-foreground">Form Fields ({formData.fields.length})</h3>
          ...
          {formData.fields.map((field, index) => (
            ...
            >
              <Card className={`p-4 transition-all duration-200 ${
                selectedField === field.id ? 'ring-2 ring-primary bg-primary/5' : 'hover:shadow-md'
              }`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mt-3 p-2 bg-background-secondary rounded-lg border">
                      <div className="flex items-center gap-2">
                        <Star className={`w-4 h-4 ${field.required ? 'text-amber-500 fill-amber-500' : 'text-muted-foreground'}`} />
                        <Label htmlFor={`required-${field.id}`} className={`text-sm font-medium ${field.required ? 'text-foreground' : 'text-muted-foreground'}`}>
