...
import { Clock, Sheet, Zap, Shield, Users, BarChart3, Sparkles, Target } from 'lucide-react'
...
export function FeaturesSection() {
  const features = [
    {
      ...
      description: "Get your first form live in under a minute. No complex configurations or technical knowledge required.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: <Sheet className="w-8 h-8" />,
      title: "Google Sheets Sync",
      description: "Automatically sync all leads to your Google Sheets. Never miss a potential customer again.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Lightning Fast",
      description: "Built for speed. Forms load instantly and submissions are processed in real-time.",
      gradient: "from-yellow-500 to-orange-500"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Enterprise Security",
      description: "Bank-level security with end-to-end encryption. Your data is safe with us.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Team Collaboration",
      description: "Share forms with your team, assign leads, and track performance together.",
      gradient: "from-indigo-500 to-blue-500"
    },
    {
      icon: <BarChart3 className="w-8 h-8" />,
      title: "Advanced Analytics",
      description: "Detailed insights on form performance, conversion rates, and lead quality.",
  ...
  return (
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-background-secondary relative overflow-hidden">
      {/* Background Pattern */}
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            From setup to conversion, we've built every feature with one goal in mind:
            <span className="text-foreground font-medium"> make lead capture effortless.</span>
          </p>
        </motion.div>
