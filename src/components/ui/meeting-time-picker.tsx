...
const generateTimeSlots = (
  ...
  if (selectedDate.toDateString() === currentDate.toDateString()) {
    ...
    nextSlot.setMinutes(Math.ceil(now.getMinutes() / duration) * duration, 0, 0, 0)
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          currentMonth && available && "text-gray-700 hover:bg-gray-100",
                          !available && currentMonth && "text-gray-300 cursor-not-allowed",
                          selected && "bg-gray-900 text-white hover:bg-gray-800",
                          today && !selected && "bg-blue-100 text-blue-900",
                          hasValue && !selected && "bg-green-100 text-green-900"
                        )}
                      >
                        {date.getDate()}
                      </button>
